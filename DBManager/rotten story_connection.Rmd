...
```{r}
i# Install package yang diperlukan
...
```{r}
dbWriteTable(db_config, "novel", novel, append = TRUE, row.names = FALSE)
dbWriteTable(db_config, "penerbit", penerbit, append = TRUE, row.names = FALSE)
dbWriteTable(db_config, "penulis", penulis, append = TRUE, row.names = FALSE)
dbWriteTable(db_config, "ulasan", ulasan, append = TRUE, row.names = FALSE)
